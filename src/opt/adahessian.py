#code from https://github.com/kozistr/pytorch_optimizer/blob/main/pytorch_optimizer/optimizer/adahessian.py
...
class AdaHessian(BaseOptimizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.validate_range(hessian_power, 'Hessian Power', -100, 100, range_type='(]')
